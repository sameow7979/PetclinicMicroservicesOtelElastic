...
sleep 20
nohup java -javaagent:opentelemetry-javaagent.jar \
-Dotel.resource.attributes="service.name=customers_server,service.version=1.1,deployment.environment=production" \
-Dotel.exporter.otlp.endpoint="https://abc40654749f4311bf845a8f8e4461d0.apm.ap-southeast-1.aws.cloud.es.io:443" \
-Dotel.exporter.otlp.headers="Authorization=Bearer YldnKGU3uvzjQkY4Of" \
-Dotel.metrics.exporter="otlp" \
-Dotel.logs.exporter="otlp" \
...
nohup java -javaagent:opentelemetry-javaagent.jar \
-Dotel.resource.attributes="service.name=visits_server,service.version=1.1,deployment.environment=production" \
-Dotel.exporter.otlp.endpoint="https://abc40654749f4311bf845a8f8e4461d0.apm.ap-southeast-1.aws.cloud.es.io:443" \
-Dotel.exporter.otlp.headers="Authorization=Bearer YldnKGU3uvzjQkY4Of" \
-Dotel.metrics.exporter="otlp" \
-Dotel.logs.exporter="otlp" \
...
nohup java -javaagent:opentelemetry-javaagent.jar \
-Dotel.resource.attributes="service.name=vets_server,service.version=1.1,deployment.environment=production" \
-Dotel.exporter.otlp.endpoint="https://abc40654749f4311bf845a8f8e4461d0.apm.ap-southeast-1.aws.cloud.es.io:443" \
-Dotel.exporter.otlp.headers="Authorization=Bearer YldnKGU3uvzjQkY4Of" \
-Dotel.metrics.exporter="otlp" \
-Dotel.logs.exporter="otlp" \
...
nohup java -javaagent:opentelemetry-javaagent.jar \
-Dotel.resource.attributes="service.name=gateway_server,service.version=1.1,deployment.environment=production" \
-Dotel.exporter.otlp.endpoint="https://abc40654749f4311bf845a8f8e4461d0.apm.ap-southeast-1.aws.cloud.es.io:443" \
-Dotel.exporter.otlp.headers="Authorization=Bearer YldnKGU3uvzjQkY4Of" \
-Dotel.metrics.exporter="otlp" \
-Dotel.logs.exporter="otlp" \
...
nohup java -javaagent:opentelemetry-javaagent.jar \
-Dotel.resource.attributes="service.name=admin_server,service.version=1.1,deployment.environment=production" \
-Dotel.exporter.otlp.endpoint="https://abc40654749f4311bf845a8f8e4461d0.apm.ap-southeast-1.aws.cloud.es.io:443" \
-Dotel.exporter.otlp.headers="Authorization=Bearer YldnKGU3uvzjQkY4Of" \
-Dotel.metrics.exporter="otlp" \
-Dotel.logs.exporter="otlp" \
